...
var roomItems = [
    ...
    room4Items = {
        desc: ("You GO TO the next room. </br>The WALLS and FLOOR are made of a dark red stone. </br>There is a MONSTER in the room. </br>There is a DOOR behind the MONSTER."),
        key: 1,
        sword: 0,
        potion: 0,
        door1: true,
...
function commands(data) {
    ...
    //trying to look at things
        ...
        if (data[1] == "walls" && roomItems[CurrentFloor].walls == true || data[1] == "wall" && roomItems[CurrentFloor].walls == true) {
            ...
            TextBoard.innerHTML += " the SWORD. It is bright and made of a silver metal. It can increase your ATTACK." + "</br>";
          } else if (data[1] == "potion" && roomItems[CurrentFloor].potion > 0) {
              TextBoard.innerHTML += " the Potion. It is red and bubbling. It is in a clear flask." + "</br>";
