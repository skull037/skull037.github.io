...
function drawExplosion(x, y) {
  ...
  var explosionInner = makeCircle(x + 25, y, 30, "cyan", "0.3")
  setTimeout(function()
             {
...
function drawFinalExplosion(x, y) {
  var explosionOuter = makeCircle(x + 25, y, 50, "blue", "0.8")
  var explosionInner = makeCircle(x + 25, y, 30, "cyan", "1")
  var i = 0;
  setTimeout(increaseBlast,0.5,i,explosionOuter,explosionInner);
}

function increaseBlast(i,ex,inn){
  if(i<725){
  ex.setAttribute("r", (50+i));
  inn.setAttribute("r", (30+i));
  i++;
    setTimeout(increaseBlast,0.5,i,ex,inn);
}
else{
    inn.setAttribute("fill", "black");
}
}
